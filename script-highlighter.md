...
| 选项 | 色值 |
|------|------|
| 护眼模式（暖杏色） | body `#F5E6D3` / container `#FDF6EC` / 正文 `#333333` |
...
| 用途 | 护眼模式 | 默认模式 |
|------|----------|----------|
| 页面底色 `body` | `#F5E6D3`（暖杏） | `#F5EDE0`（茶白） |
| 卡片底色 `.container` | `#FDF6EC` | `#FFFBF5` |
| 正文色 | `#333333` | `#2c2c2c` |
| 标题色 `h1` | `#5A3E2E` | `#8B4513` |
| 场景标题 `.scene-title` | `#5A3E2E` / 边框 `#E0D0B8` | `#8B4513` / 边框 `#E8DDD0` |
| 图例/目录底色 | `#E8D8C0` | `#F5EDE0` |
